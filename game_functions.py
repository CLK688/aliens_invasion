...
def updata_screen(ai_settings, screen, stats, sb, ship, bullets, aliens, play_button):
    """更新屏幕上的图像，并切换到新的屏幕"""
    #每次循环时都会重新绘制屏幕
...
def update_aliens(ai_settings, stats, sb, screen, ship, aliens, bullets):
        """检查是否有外星人位于主屏幕的边缘，并更新外星人群中所有外星人的位置"""
...
def check_high_score(stats, sb):
    if stats.score > stats.high_score:
        ...
        sb.prep_high_score()
        with open("history_high_score.json","w") as f:
